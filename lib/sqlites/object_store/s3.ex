defmodule Sqlites.ObjectStore.S3 do
  @moduledoc """
  S3-compatible object store via `req_s3` (AWS S3, MinIO, R2, ...).
  Configured under `config :sqlites, Sqlites.ObjectStore` with
  ...
  defp config, do: Application.fetch_env!(:sqlites, Sqlites.ObjectStore)
end
